...
const leftFeatures: FeatureItem[] = [
  {
    ...
    description:
      'Our AI automatically extracts and analyzes skills from GitHub and LinkedIn profiles for accurate matching.',
    position: 'left',
  ...
  },
  {
    ...
    description:
      'Find developers by skills, experience level, college, or project interests with powerful filtering.',
    position: 'left',
    cornerStyle: 'sm:-translate-x-4 sm:rounded-br-[2px]',
  },
  {
    ...
    description:
      'Seamlessly connect your GitHub to showcase real projects and automatically update your skill profile.',
    position: 'left',
...
const rightFeatures: FeatureItem[] = [
  {
    ...
    description:
      'Get detailed compatibility scores and role recommendations for optimal team formation.',
    position: 'right',
  ...
  },
  {
    ...
    description:
      'Find the perfect teammates for your specific project needs and complementary skill sets.',
    position: 'right',
    cornerStyle: 'sm:translate-x-4 sm:rounded-bl-[2px]',
  },
  {
    ...
    description:
      'Real-time AI analysis provides immediate insights into collaboration potential and synergies.',
    position: 'right',
...
export function FeaturesSection() {
  return (
    <section className="pt-20 pb-8 section-divider" id="features">
        ...
        <div className="flex flex-col-reverse gap-6 md:grid md:grid-cols-3">
          ...
          <div className="order-[1] mb-6 self-center sm:order-[0] md:mb-0">
            ...
            <h2 className="text-foreground mb-2 text-center text-2xl sm:mb-2.5 md:text-[2rem]">
              Key Benefits of HackMate
            </h2>
            <p className="text-muted-foreground mx-auto max-w-[18rem] text-center text-pretty">
              Discover how our platform revolutionizes developer collaboration through intelligent matching
            </p>
          </div>
